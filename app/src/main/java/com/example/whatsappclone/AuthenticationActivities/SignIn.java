...
//                Directly enters main screen
        ...
        binding.CreateNewAccountText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    int RC_SIGN_IN = 10 ; //  can be any number less than 100
